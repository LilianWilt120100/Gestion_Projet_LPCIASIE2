...
export const startTimer = () =>
  new Promise((resolve) => {
    timer = setTimeout(resolve, GAME_DURATION_MS);
    startTime = Date.now();
    endTime = null;
  });
...
export const getTimeLeft = () =>
  timer ? Math.ceil((startTime - Date.now()) / 1000) : null;
...
export const getTotalDuration = () =>
  startTime && endTime ? (startTime - endTime) / 100 : null;
